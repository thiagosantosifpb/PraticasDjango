...
from .api_views import AutorViewSet, EditoraViewSet
...
router.register(r'editoras', EditoraViewSet, basename='api-editoras')
...
urlpatterns = [
    ...
    path("publicacoes/<int:pk>/editar/", PublicaUpdateView.as_view(), name="editar_publicacao"),
    path("publicacoes/<int:pk>/excluir/", PublicaDeleteView.as_view(), name="excluir_publicacao"),
